...
function share(e, t) {
    var s = 626,
        o = 496,
        i = screen.width / 2 - s / 2,
        a = screen.height / 2 - o / 2;
    switch (t) {
        case "facebook":
            window.open("http://www.facebook.com/sharer/sharer.php?u=" + e, "facebook-share-dialog", "width=" + s + ",height=" + o + ",top=" + a + ",left=" + i);
            break;
        case "google":
            window.open("https://plus.google.com/share?url=" + e, "google-plus-share-dialog", "width=" + s + ",height=" + o + ",top=" + a + ",left=" + i);
            break;
        case "vk":
            window.open("http://vk.com/share.php?url=" + e, "vk-share-dialog", "width=" + s + ",height=" + o + ",top=" + a + ",left=" + i);
            break;
        case "twitter":
            window.open("http://twitter.com/intent/tweet?status=" + e, "twitter-share-dialog", "width=" + s + ",height=" + o + ",top=" + a + ",left=" + i)
    }
}
...
$(document).ready(function() {
    ...
    if ($("#toggle-filter, #filter-close").click(function () {
            $("#filter, #toggle-filter").toggleClass("active")
        }), $("#sl-more").click(function () {
            $(".server-list-item").toggleClass("expand")
        }), $(".toggledub").click(function () {
            $(".toggledub").toggleClass("active")
        }), $(".gc-expand").click(function () {
            $(".play-film").toggleClass("play-film-expand"), $(".gc-expand").toggleClass("active"), $("#padding-expand").toggle()
        }), $(".gc-share").click(function () {
            $(".block-share").toggle()
        }), $(".gc-light, #overlay").click(function () {
            $(".gc-light, #overlay").toggleClass("active"), $("#media-play").toggleClass("media-play-active")
        }), $("#toggle-schedule").click(function () {
            $("#toggle-schedule").toggleClass("active"), $(".se-list").toggle()
            ...
            function e() {
                ...
                e.css("display", "block"), t.css("margin-top", Math.max(0, ($(window).height() - t.height()) / 3))
            }
